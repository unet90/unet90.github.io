...
<head>
    ...
    <meta name="description" content="Мы приглашаем Вас посетить кафе &quot;Арин-Берд&quot; и почувствовать атмосферу дворца Армении! Оцените по достоинству фирменные блюда нашего кафе" />
    <meta name="keywords" content="кафе, ресторан, Алчевск, алчевск, ЛНР, лнр, LPR, cafe, eat, Alchevsk, Арин-Берд, арин, берд, arin-berd, arinberd, аринберд, кафе алчевск, шашлык в алчевске, акоп, у акопа, окоп">
    <meta name="yandex-verification" content="669e4449a10598ef" />
    ...
    <style>body {cursor: url(../images/cursor.png), progress !important;}</style>
    ...
    <div class="animsition global-wrapper">
        <div id="header" class="header-wrapper">
            ...
            <div class="order">
                ...
                <div class="order2">
                    <a href="#" title="Заказать звонок" class="more form-link">Заказать звонок</a>
                       <div class="modal-form">
                        <img id="close-form" src="images/close.png" alt="X">
                        <p class="h3">Оставьте свой телефон &ndash; и мы Вам перезвоним в ближайшее время!</p>
<!--                        <form action="database/contact.php" method="post">-->
                        <form id="contact-form">                         
                            <input name="phone" type="tel" required placeholder="* Номер телефона" id="user_phone" class="user-phone form-input" title="Заполните это поле"/>
                            <input name="name" class="form-input validation" pattern="^[а-яА-ЯёЁa-zA-Z]+$" placeholder="* Ваше имя" value="" required="" type="text" title="Заполните это поле">
                            <input class="submit-input" value="Жду звонка!" type="submit">
                        </form>
                        </div>
                    <div class="clear"></div>
                    <div id="overlay"></div>
                ...
                <div class="main-menu">
                    <div class="menu-main-nav-menu-container">
                        <ul id="menu-main-nav-menu" class="sf-menu">
                            <li class="menu-item menu-item-home current-menu-item current_page_item"><a href="index.php">Главная</a></li>
        ...
        <div class="mobile-menu-wrapper">
            <div class="menu-main-nav-menu-container">
                <ul id="menu-main-nav-menu-1" class="mobile-menu">
                    <li class="menu-item menu-item-home current-menu-items current_page_item"><a href="index.php">Главная</a></li>
                    <li class="menu-item"><a href="menu.php">Меню</a></li>
                    <li class="menu-item"><a href="mangal.php">Мангал</a></li>
                    <li class="menu-item"><a href="calc.php">Ваше Меню</a></li>
                    <li class="menu-item"><a href="about.php">О нас</a></li>
